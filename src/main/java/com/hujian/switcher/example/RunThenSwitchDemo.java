...
import com.hujian.switcher.annotation.RunThenSwitch;
import com.hujian.switcher.annotation.RunThenSwitchResolver;
 ...
 */
public class RunThenSwitchDemo {
    ...
    @RunThenSwitch(switchToExecutorServiceType = MULTI_COMPUTE_EXECUTOR_SERVICE)
    public static AnnotationServcie.StupidRunner stupidRunnerA;

    @RunThenSwitch(switchToExecutorServiceName = "stupid-executorService")
    public static AnnotationServcie.StupidRunner stupidRunnerB;

    @RunThenSwitch(CreateType = MULTI_IO_EXECUTOR_SERVICE)
    ...
    public static void main(String ... args) throws InterruptedException, NoSuchMethodException,
        ...
        RunThenSwitchResolver resolver = new RunThenSwitchResolver();
        resolver.execute();
