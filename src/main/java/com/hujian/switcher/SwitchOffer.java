...
public interface SwitchOffer<T> {
     ...
     *      RUN AT AN NEW SCHEDULE {@link com.hujian.switcher.schedulers.core.Schedulers#NEW_THREAD#}
     ...
     * {@link com.hujian.switcher.schedulers.core.Schedulers#from(Executor)}
     ...
     * {@link com.hujian.switcher.schedulers.core.Schedulers#IO#}
    ...
    /**
     * switch to the IoHolder Schedule auto.the Switcher will switch to
     * {@link com.hujian.switcher.schedulers.core.Schedulers#COMPUTATION#}
     * schedule, then the runnable will run by the schedule.
     * @return the switcher context
     */
    ...
    /**
     * switch to the IoHolder Schedule auto.the Switcher will switch to
     * {@link com.hujian.switcher.schedulers.core.Schedulers#NEW_THREAD#}
     * schedule, then the runnable will run by the schedule.
     * @return the switcher context
     */
    ...
    /**
     * switch to the IoHolder Schedule auto.the Switcher will switch to
     * {@link com.hujian.switcher.schedulers.core.Schedulers#SINGLE#}
     * schedule, then the runnable will run by the schedule.
     * @return the switcher context
     */
