...
【4】为release 1.0.2 做准备，但是目前考虑再丰富和完善“schedulers”模块之后直接将版本变为1.1.0，因为可以说已经到了一个该了结的节点了！！
#2017-08-31#
【1】修复一些发现的bug，调整代码格式，1.1.0目前已经可用，未来将继续加入新的功能。
【2】2.0版本的switcher在schedulers模块内，1.0版本的switcher在主模块内，1.0版本和2.0版本的区别在于executor的管理方式，以及对
    各类线程的executor候选方案不同，具体可见代码。
```
